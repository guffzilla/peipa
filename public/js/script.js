    ...
    $(".nav-item").hover(function(){
        $(this).css("background-color", "#6e8fb1");
        }, function(){
        $(this).css("background-color", "#367eb1");
      });
    ...
    $('main').find('.btn-group, .btn, .navbar, .modal, .form-group, .list-group, .progress, .table-responsive, .badge, .nav').each(function(){
        var $this = $(this);
